...
// writeFiles writes generated files with deduplication of directory creation.
func writeFiles(root string, files []GeneratedFile, force bool) error {
    // Track created directories to avoid redundant os.MkdirAll calls
    ...
    for _, file := range files {
        ...
        // Only create directory if not already created this session
        if !createdDirs[dir] {
